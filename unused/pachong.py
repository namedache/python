...
class WeiBoLogin(object):
    ...
    def __init__(self):
        ...
        self.session.headers.update({"User-Agent": "Mozilla/5.0 (Macintosh; Intel Mac OS X 10_14_4) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/73.0.3683.103 Safari/537.36"})
...
if __name__ == "__main__":
    ...
    weibo = WeiBoLogin()
    weibo.login("13750712651", "602651")
    myurl = "my"
    htmlContent = urllib3.urlopen(myurl).read()
